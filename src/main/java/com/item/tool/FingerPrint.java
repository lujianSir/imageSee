...
public final class FingerPrint {
	...
	public static String compare(String filepath1, String filepath2) throws IOException {
		String message = "";
		FingerPrint fp1 = new FingerPrint(ImageIO.read(new File(filepath1)));
		FingerPrint fp2 = new FingerPrint(ImageIO.read(new File(filepath2)));
		message = "两张图片的相似度:" + fp1.compare(fp2) * 100 + "%";
		return message;
	}
	...
	public static void main(String[] args) throws Exception {
		FingerPrint fp1 = new FingerPrint(ImageIO.read(new File("D:/image/t4.png")));
		FingerPrint fp2 = new FingerPrint(ImageIO.read(new File("D:/image/t1.png")));
